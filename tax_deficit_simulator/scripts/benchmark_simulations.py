...
@click.command()
@click.argument('path')
def benchmark_simulations(path):
    ...
    diff_1 = np.abs(FRA_result_1 - FRA_result_2)
    diff_2 = np.abs(FRA_result_1 - FRA_result_3)
    diff_3 = np.abs(FRA_result_2 - FRA_result_3)

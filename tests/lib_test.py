...
import os
import tax-deficit-simulator
import pandas as pd
# Import from our lib
from tax-deficit-simulator.lib import clean_data
import pytest


def test_clean_data():
    datapath = os.path.dirname(os.path.abspath(tax-deficit-simulator.__file__)) + '/data'
